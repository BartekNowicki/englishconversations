...
export const clickablesPl = [
  ...
  "zawaleni",
  "doceniać drobne rzeczy",
  "ciągną nas w różnych kierunkach",
  "przemknęło",
  "łatwiej powiedzieć niż zrobić",
  "dobiega końca",
  "To boli",
  "odhaczyć z listy",
  "ma sposób na podważanie",
  "najlepszych planów",
  "być bardziej elastycznym z",
  "spowolnić",
  "ściganie się z czasem",
  "zastanowić się nad tym, co naprawdę ważne",
  "zaakceptować wolniejsze tempo",
  "przygotować się na to, co przed nami",
  "biegamy na pełnych obrotach",
  "zostajesz w tyle",
  "jest czymś złym",
  "wziąć to na luzie",
  "zostawić miejsce na",
